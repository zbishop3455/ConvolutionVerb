...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "8.0.2"
  WORKING_DIRECTORY "/Users/zbishop/Coding/ConvolutionVerb/libs/juce"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/zbishop/Coding/ConvolutionVerb/libs/juce'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/zbishop/Coding/ConvolutionVerb/libs/juce'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
